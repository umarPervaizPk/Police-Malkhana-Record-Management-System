    ...
    <table>
        ...
        <tr>
            ...
            <td class="record-actions">
                <a href="edit_record.php?id=<?php echo $record['id']; ?>">ترمیم کریں</a> | 
                <a href="search_case.php?delete_id=<?php echo $record['id']; ?>" onclick="return confirm('کیا آپ اس ریکارڈ کو حذف کرنا چاہتے ہیں؟')">حذف کریں</a>
            </td>
        </tr>
    </table>
