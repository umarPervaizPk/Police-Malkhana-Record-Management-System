    ...
    <table>
        ...
        <tr>
            ...
            <td class="record-actions">
              <a href="delete_record.php?delete_id=<?php echo $record['id']; ?>" class="btn btn-delete" onclick="return confirm('کیا آپ اس ریکارڈ کو حذف کرنا چاہتے ہیں؟')">حذف کریں</a>
            </td>
        </tr>
    </table>
